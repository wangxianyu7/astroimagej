        ...
        gd.addNewSwappableSectionPanel(ApertureShape.class, (d, shape) -> {
            switch (shape) {
                case CIRCULAR, ELLIPTICAL -> {
                    ...
                    var bottomChecks = d.addCheckboxGroup(2, 3, new String[]{I18n.t("multiap.update_plot"), I18n.t("multiap.update_image"),
                                    I18n.t("multiap.show_help"), "Enable programmable title", "Enable programmable subtitle"},
                ...
                case FREEFORM -> {
                    ...
                    list2.add(ENABLE_PROGRAMMABLE_TITLE::set);
                    list2.add(ENABLE_PROGRAMMABLE_SUBTITLE::set);
                    var bottomChecks = d.addCheckboxGroup(2, 2, new String[]{I18n.t("multiap.update_plot"), I18n.t("multiap.update_image"),
